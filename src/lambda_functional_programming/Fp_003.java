...
public class Fp_003 {
    ...
    public static void buyukHarfleYazdir(List<String> list){
        ...
        list.stream().map(String::toUpperCase).forEach(Utils::ayniSatirdaBosluklaYazdir);  //for each ile yazdırma islemini yaptık
    }

    //2. Yol

//    public static void buyukHarfleYazdir02(List<String> list){
//        list.replaceAll(String::toUpperCase);  // list mutable dir. replaceAll kalici degisiklik yapar 1.yolda stream degisiklige izin vermez
...
//    }
    ...
    public static void uzunlugaGoreYazdir(List<String> list){
        ...
        list.stream().sorted(Comparator.comparing(String::length))
                .forEach(Utils::ayniSatirdaBosluklaYazdir);//Comparator.comparing(): Sıralama koşulunu belirtmek için kullanılır.
